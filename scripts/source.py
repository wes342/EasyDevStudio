...
def arch_detect(self):
    import subprocess as sp
    os_32 = '''sudo apt-get install git-core gnupg sun-java6-jdk flex bison gperf libsdl-dev 
    libesd0-dev libwxgtk2.6-dev build-essential zip curl libncurses5-dev zlib1g-dev'''
    os_64 = '''gksudo apt-get install git-core gnupg sun-java6-jdk flex bison gperf libsdl-dev libesd0-dev 
    libwxgtk2.6-dev build-essential zip curl libncurses5-dev zlib1g-dev ia32-libs lib32z1-dev 
    lib32ncurses5-dev gcc-multilib g++-multilib '''
    if (platform.machine() == 'i686'):       
        sp.Popen("gnome-terminal -e '%s'" % (os_32), shell=True)
        
    elif (platform.machine() == 'x86_64'):
        sp.Popen("gnome-terminal -e '%s'" % (os_64), shell=True)
