...
def select_base(self):   
    ...
    source = CustomButton(text='Build Source', pos_hint={'x':.0, 'y':.350}, size_hint=(.90, .06))
    extract = CustomButton(text='Extract From RUU', pos_hint={'x':.0, 'y':.250}, size_hint=(.90, .06))
    port = CustomButton(text='Rom Porting', pos_hint={'x':.0, 'y':.150}, size_hint=(.90, .06))
    ...
    self.panel_layout.add_widget(source)
